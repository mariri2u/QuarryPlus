...
public class BlockPlacer extends BlockContainer {
	...
	public int getBlockTextureFromSideAndMetadata(int par1, int par2) {
		int k = par2 & 7;
		return par1 == k ? (k != 1 && k != 0 ? 98 : 99) : (k != 1 && k != 0 ? (par1 != 1 && par1 != 0 ? 96 : 97) : 97);
	}
	...
	@Override
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLivingBase) {
		int l = BlockPistonBase.determineOrientation(par1World, par2, par3, par4, (EntityPlayer) par5EntityLivingBase);
