...
public class TileMarker extends APacketTile implements IAreaProvider {
	...
	static class Link {
		...
		void makeLaser() {
			...
			if ((flag & 1) == 1) {
				this.lasers[0] = new EntityBlock(this.w, this.xn + a, this.yn + b, this.zn + b, this.xx - this.xn, c, c, BuildCraftCore.redLaserTexture);
			}
			if ((flag & 2) == 2) {
				this.lasers[4] = new EntityBlock(this.w, this.xn + b, this.yn + a, this.zn + b, c, this.yx - this.yn, c, BuildCraftCore.redLaserTexture);
			}
			if ((flag & 4) == 4) {
				this.lasers[8] = new EntityBlock(this.w, this.xn + b, this.yn + b, this.zn + a, c, c, this.zx - this.zn, BuildCraftCore.redLaserTexture);
			}
			if ((flag & 3) == 3) {
				this.lasers[2] = new EntityBlock(this.w, this.xn + a, this.yx + b, this.zn + b, this.xx - this.xn, c, c, BuildCraftCore.redLaserTexture);
				this.lasers[6] = new EntityBlock(this.w, this.xx + b, this.yn + a, this.zn + b, c, this.yx - this.yn, c, BuildCraftCore.redLaserTexture);
			}
			if ((flag & 5) == 5) {
				this.lasers[1] = new EntityBlock(this.w, this.xn + a, this.yn + b, this.zx + b, this.xx - this.xn, c, c, BuildCraftCore.redLaserTexture);
				this.lasers[9] = new EntityBlock(this.w, this.xx + b, this.yn + b, this.zn + a, c, c, this.zx - this.zn, BuildCraftCore.redLaserTexture);
			}
			if ((flag & 6) == 6) {
				this.lasers[5] = new EntityBlock(this.w, this.xn + b, this.yn + a, this.zx + b, c, this.yx - this.yn, c, BuildCraftCore.redLaserTexture);
				this.lasers[10] = new EntityBlock(this.w, this.xn + b, this.yx + b, this.zn + a, c, c, this.zx - this.zn, BuildCraftCore.redLaserTexture);
			}
			if ((flag & 7) == 7) {
				this.lasers[3] = new EntityBlock(this.w, this.xn + a, this.yx + b, this.zx + b, this.xx - this.xn, c, c, BuildCraftCore.redLaserTexture);
				this.lasers[7] = new EntityBlock(this.w, this.xx + b, this.yn + a, this.zx + b, c, this.yx - this.yn, c, BuildCraftCore.redLaserTexture);
				this.lasers[11] = new EntityBlock(this.w, this.xx + b, this.yx + b, this.zn + a, c, c, this.zx - this.zn, BuildCraftCore.redLaserTexture);
			}
			for (EntityBlock eb : this.lasers)
				if (eb != null) eb.worldObj.spawnEntityInWorld(eb);
		}
