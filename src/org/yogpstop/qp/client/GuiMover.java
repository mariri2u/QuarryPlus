...
public class GuiMover extends GuiContainer {
	...
	public void initGui() {
		...
		this.controlList.add(this.b32 = new GuiButton(32, i + 27, j + 20, 60, 20, StatCollector.translateToLocal("enchantment.digging") + ">"));
		this.controlList.add(this.b33 = new GuiButton(33, i + 27, j + 50, 60, 20, StatCollector.translateToLocal("enchantment.untouching") + ">"));
		this.controlList.add(this.b34 = new GuiButton(34, i + 89, j + 20, 60, 20, StatCollector.translateToLocal("enchantment.durability") + ">"));
		this.controlList.add(this.b35 = new GuiButton(35, i + 89, j + 50, 60, 20, StatCollector.translateToLocal("enchantment.lootBonusDigger") + ">"));
	}
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		this.mc.renderEngine.bindTexture(this.mc.renderEngine.getTexture("/mods/yogpstop_qp/textures/gui/mover.png"));
