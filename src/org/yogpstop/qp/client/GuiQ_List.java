...
public class GuiQ_List extends GuiScreenA {
	...
	public void initGui() {
		...
		this.controlList.add(new GuiButton(PacketHandler.CtS_TOGGLE_FORTUNE + this.targetid, this.width * 2 / 3 + 10, 140, 100, 20, StatCollector
				.translateToLocal(include() ? "tof.include" : "tof.exclude")));
		this.controlList.add(this.delete = new GuiButton(PacketHandler.CtS_REMOVE_FORTUNE + this.targetid, this.width * 2 / 3 + 10, 110, 100, 20, StatCollector
